...
const dictEn: { [key in keyof Dict]: string } = {
  ...
  sectionNamePlaceholder: 'e.g., demographicinfo',
  wrapperClass: 'Wrapper CSS Class',
  wrapperClassPlaceholder: 'e.g., wes-demographic-section',
  exportAsFragment: 'Export as HTML Fragment',
  exportHTMLFragments: 'Export HTML Fragments',
  exportRazor: 'Export Razor (.cshtml)',
...
const dictZh: { [key in keyof Dict]: string } = {
  ...
  renameGroup: '重命名组',
  deleteGroup: '删除组',
  deleteGroupAndFields: '删除组和字段',
  deleteGroupConfirm: '您确定要删除此组吗？字段将被保留。',
  deleteGroupAndFieldsConfirm: '您确定要删除此组及其所有字段吗？',
  hideAllFields: '隐藏所有字段',
  showAllFields: '显示所有字段',
  addFieldsToGroup: '添加字段到组',
  removeFromGroup: '从组中删除',
  ungrouped: '未分组',
  groupNameRequired: '组名称是必需的',
  groupNameExists: '组名称已存在',
  fieldGroups: '字段组',
  setCondition: '设置条件',
  groupCondition: '组条件',
  ...
  sectionSettings: '部分设置',
  sectionName: '部分名称',
  sectionNamePlaceholder: '例如, demographicinfo',
  wrapperClass: '包装器CSS类',
  wrapperClassPlaceholder: '例如, wes-demographic-section',
  exportAsFragment: '导出为HTML片段',
  exportHTMLFragments: '导出HTML片段',
  exportRazor: '导出Razor (.cshtml)',
...
const dictJa: { [key in keyof Dict]: string } = {
  ...
  deleteGroup: 'グループを削除',
  deleteGroupAndFields: 'グループとフィールドを削除',
  deleteGroupConfirm: 'このグループを削除してもよろしいですか？フィールドは保持されます。',
  deleteGroupAndFieldsConfirm: 'このグループとすべてのフィールドを削除してもよろしいですか？',
  hideAllFields: 'すべてのフィールドを非表示',
  showAllFields: 'すべてのフィールドを表示',
  addFieldsToGroup: 'グループにフィールドを追加',
  removeFromGroup: 'グループから削除',
  ungrouped: 'グループなし',
  groupNameRequired: 'グループ名が必要です',
  groupNameExists: 'グループ名は既に存在します',
  fieldGroups: 'フィールドグループ',
  setCondition: '条件を設定',
  ...
  conditionPreview: 'プレビュー',
  saveCondition: '条件を保存',
  removeCondition: '条件を削除',
  sectionSettings: 'セクション設定',
  sectionName: 'セクション名',
  sectionNamePlaceholder: '例: demographicinfo',
  wrapperClass: 'ラッパーCSSクラス',
  wrapperClassPlaceholder: '例: wes-demographic-section',
  exportAsFragment: 'HTMLフラグメントとしてエクスポート',
  exportHTMLFragments: 'HTMLフラグメントをエクスポート',
  exportRazor: 'Razorエクスポート (.cshtml)',
...
const dictKo: { [key in keyof Dict]: string } = {
  ...
  deleteGroup: '그룹 삭제',
  deleteGroupAndFields: '그룹 및 필드 삭제',
  deleteGroupConfirm: '이 그룹을 삭제하시겠습니까? 필드는 유지됩니다.',
  deleteGroupAndFieldsConfirm: '이 그룹과 모든 필드를 삭제하시겠습니까?',
  hideAllFields: '모든 필드 숨기기',
  showAllFields: '모든 필드 표시',
  addFieldsToGroup: '그룹에 필드 추가',
...
const dictAr: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'حذف المجموعة والحقول',
  deleteGroupConfirm: 'هل أنت متأكد من رغبتك في حذف هذه المجموعة؟ سيتم الاحتفاظ بالحقول.',
  deleteGroupAndFieldsConfirm: 'هل أنت متأكد من رغبتك في حذف هذه المجموعة وجميع حقولها؟',
  hideAllFields: 'إخفاء جميع الحقول',
  showAllFields: 'إظهار جميع الحقول',
  addFieldsToGroup: 'إضافة حقول إلى المجموعة',
  removeFromGroup: 'إزالة من المجموعة',
  ungrouped: 'غير مجمع',
  groupNameRequired: 'اسم المجموعة مطلوب',
  groupNameExists: 'اسم المجموعة موجود بالفعل',
  fieldGroups: 'مجموعات الحقول',
  setCondition: 'تعيين الشرط',
  groupCondition: 'شرط المجموعة',
  conditionVariable: 'متغير',
  conditionOperator: 'عامل',
  conditionValue: 'قيمة',
  enableCondition: 'تمكين الشرط',
  conditionPreview: 'معاينة',
  saveCondition: 'حفظ الشرط',
...
const dictTh: { [key in keyof Dict]: string } = {
  ...
  deleteGroup: 'ลบกลุ่ม',
  deleteGroupAndFields: 'ลบกลุ่มและฟิลด์',
  deleteGroupConfirm: 'คุณแน่ใจหรือไม่ว่าต้องการลบกลุ่มนี้? ฟิลด์จะถูกเก็บไว้',
  deleteGroupAndFieldsConfirm: 'คุณแน่ใจหรือไม่ว่าต้องการลบกลุ่มนี้และฟิลด์ทั้งหมด?',
  hideAllFields: 'ซ่อนฟิลด์ทั้งหมด',
  showAllFields: 'แสดงฟิลด์ทั้งหมด',
  addFieldsToGroup: 'เพิ่มฟิลด์ไปยังกลุ่ม',
  removeFromGroup: 'ลบออกจากกลุ่ม',
  ungrouped: 'ไม่ได้จัดกลุ่ม',
  groupNameRequired: 'จำเป็นต้องมีชื่อกลุ่ม',
  groupNameExists: 'ชื่อกลุ่มมีอยู่แล้ว',
  fieldGroups: 'กลุ่มฟิลด์',
  setCondition: 'ตั้งเงื่อนไข',
  groupCondition: 'เงื่อนไขกลุ่ม',
  conditionVariable: 'ตัวแปร',
  conditionOperator: 'ตัวดำเนินการ',
  conditionValue: 'ค่า',
  enableCondition: 'เปิดใช้งานเงื่อนไข',
  conditionPreview: 'ดูตัวอย่าง',
  saveCondition: 'บันทึกเงื่อนไข',
...
const dictIt: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'Elimina Gruppo e Campi',
  deleteGroupConfirm: 'Sei sicuro di voler eliminare questo gruppo? I campi saranno mantenuti.',
  deleteGroupAndFieldsConfirm: 'Sei sicuro di voler eliminare questo gruppo e tutti i suoi campi?',
  hideAllFields: 'Nascondi Tutti i Campi',
  showAllFields: 'Mostra Tutti i Campi',
  addFieldsToGroup: 'Aggiungi Campi al Gruppo',
  removeFromGroup: 'Rimuovi dal Gruppo',
  ungrouped: 'Non Raggruppato',
  groupNameRequired: 'Il nome del gruppo è richiesto',
  groupNameExists: 'Il nome del gruppo esiste già',
  fieldGroups: 'Gruppi di Campi',
  setCondition: 'Imposta Condizione',
  groupCondition: 'Condizione Gruppo',
  conditionVariable: 'Variabile',
  conditionOperator: 'Operatore',
  conditionValue: 'Valore',
  enableCondition: 'Abilita condizione',
  conditionPreview: 'Anteprima',
  saveCondition: 'Salva Condizione',
...
const dictPl: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'Usuń Grupę i Pola',
  deleteGroupConfirm: 'Czy na pewno chcesz usunąć tę grupę? Pola zostaną zachowane.',
  deleteGroupAndFieldsConfirm: 'Czy na pewno chcesz usunąć tę grupę i wszystkie jej pola?',
  hideAllFields: 'Ukryj Wszystkie Pola',
  showAllFields: 'Pokaż Wszystkie Pola',
  addFieldsToGroup: 'Dodaj Pola do Grupy',
  removeFromGroup: 'Usuń z Grupy',
  ungrouped: 'Niezgrupowane',
  groupNameRequired: 'Nazwa grupy jest wymagana',
  groupNameExists: 'Nazwa grupy już istnieje',
  fieldGroups: 'Grupy Pól',
  setCondition: 'Ustaw Warunek',
  groupCondition: 'Warunek Grupy',
  conditionVariable: 'Zmienna',
  conditionOperator: 'Operator',
  conditionValue: 'Wartość',
  enableCondition: 'Włącz warunek',
  conditionPreview: 'Podgląd',
...
const dictDe: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'Gruppe und Felder Löschen',
  deleteGroupConfirm: 'Möchten Sie diese Gruppe wirklich löschen? Die Felder bleiben erhalten.',
  deleteGroupAndFieldsConfirm: 'Möchten Sie diese Gruppe und alle zugehörigen Felder wirklich löschen?',
  hideAllFields: 'Alle Felder Ausblenden',
  showAllFields: 'Alle Felder Anzeigen',
  addFieldsToGroup: 'Felder zur Gruppe Hinzufügen',
  removeFromGroup: 'Aus Gruppe Entfernen',
  ungrouped: 'Nicht Gruppiert',
  groupNameRequired: 'Gruppenname ist erforderlich',
  groupNameExists: 'Gruppenname existiert bereits',
...
const dictEs: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'Eliminar Grupo y Campos',
  deleteGroupConfirm: '¿Estás seguro de que quieres eliminar este grupo? Los campos se conservarán.',
  deleteGroupAndFieldsConfirm: '¿Estás seguro de que quieres eliminar este grupo y todos sus campos?',
  hideAllFields: 'Ocultar Todos los Campos',
  showAllFields: 'Mostrar Todos los Campos',
  addFieldsToGroup: 'Agregar Campos al Grupo',
...
const dictFr: { [key in keyof Dict]: string } = {
  ...
  deleteGroupAndFields: 'Supprimer le Groupe et les Champs',
  deleteGroupConfirm: 'Êtes-vous sûr de vouloir supprimer ce groupe ? Les champs seront conservés.',
  deleteGroupAndFieldsConfirm: 'Êtes-vous sûr de vouloir supprimer ce groupe et tous ses champs ?',
  hideAllFields: 'Masquer Tous les Champs',
  showAllFields: 'Afficher Tous les Champs',
  addFieldsToGroup: 'Ajouter des Champs au Groupe',
  removeFromGroup: 'Retirer du Groupe',
  ungrouped: 'Non Groupé',
  groupNameRequired: 'Le nom du groupe est requis',
  groupNameExists: 'Le nom du groupe existe déjà',
  fieldGroups: 'Groupes de Champs',
  setCondition: 'Définir Condition',
  groupCondition: 'Condition du Groupe',
  conditionVariable: 'Variable',
  conditionOperator: 'Opérateur',
  conditionValue: 'Valeur',
  enableCondition: 'Activer la condition',
  conditionPreview: 'Aperçu',
  saveCondition: 'Enregistrer Condition',
